...
## Dado el comando, el límite de memoria swap es de 1 Gigabyte, es decir, 1024 Megabytes. Por lo tanto, aplicando la fórmula de memoria swap máxima disponible se tiene:
```
Memoria swap máxima = *memory-swap − memory
Memoria swap máxima = 1024 − 300
Memoria swap máxima = 724 Megabytes
```
